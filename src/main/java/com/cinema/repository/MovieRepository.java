...
public interface MovieRepository
	...
	List<Movie> findByPriceLessThanOrderByPriceDesc(Integer price);

	// Dto로 바로 넣어주는 native 쿼리를 사용시에 쿼리문에서 별칭을 반드시 줘야 Dto 객체에서 인식한다.
	// 가장 판매순위가 높은 6개의 데이터
//	@Query(value = "select data.num num, movie.mv_id id, movie.movie_nm movieNm, movie.price price, movie_img.img_url imgUrl, movie_img.repimg_yn repimgYn \r\n"
//			+ "            from movie \r\n"
